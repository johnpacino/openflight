...
class TestIWR6843ShotIntegration:
    ...
    def test_init_iwr6843_wires_horizontal_aim_inputs_into_runtime(self, monkeypatch, tmp_path):
        """Horizontal aim inputs must reach IWR6843Runtime, not just be parsed.
        ...
        assert server_module.init_iwr6843(
            ...
            horizontal_phase_reference_rad=-0.493587,
        )

        assert server_module.iwr6843_runtime.azimuth_offset_deg == 1.5
        assert server_module.iwr6843_runtime.horizontal_phase_reference_rad == pytest.approx(
            -0.493587
        )
        assert server_module.iwr6843_runtime_config["azimuth_offset_deg"] == 1.5
        assert server_module.iwr6843_runtime_config[
            "horizontal_phase_reference_rad"
        ] == pytest.approx(-0.493587)
        server_module.iwr6843_runtime = None
